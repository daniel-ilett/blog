...
For us, it'll let us light the edges of objects as they curve away from us - imagine a ball; we'll light the 'edges' of the ball. It's also known as 'rim lighting' in computer graphics becasue we commonly use it to light the rim of objects. It's also called 'back lighting' in photography, because you put a light source behind the object.
...
Out lighting calculation is looking fairly complex now! Luckily for us, we're done here. Let's take a look at Ethan now.
