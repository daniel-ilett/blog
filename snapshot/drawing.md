            ...
            <div class="col-lg-12 col-md-12 nopadding doc-page">
                <div class="col-lg-3 col-md-12 nopadding doc-nav">
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <hr/>
                        <li class="active"><a href="#">Drawing <span class="badge">1.2</span></a></li>
                ...
                <div class="col-lg-9 col-md-12 doc-content">
                    ...
                    <p class="box-error">
                        This effect requires the <b>Drawing Texture</b> to be set in order to work properly. An example is provided at <b>Resources/Textures/DrawingTex.png</b>.
                    </p>
                    <h2>Parameters</h2>
                    <h3>Strength <span class="badge">Float</span></h3>
                        How noticeable the effect is.
                    <h3>Drawing Texture <span class="badge">Texture2D</span></h3>
                        The texture which encodes what the drawing pattern looks like.
                    <h3>Animation Cycle Time <span class="badge">Float</span></h3>
                    ...
                    <h3>Tiling <span class="badge">Float</span></h3>
                        The number of times the drawing texture is tiled (in the y-direction).
                    <h3>Smudge <span class="badge">Float</span></h3>
                    ...
                    <h3>Depth Threshold <span class="badge">Bool</span></h3>
