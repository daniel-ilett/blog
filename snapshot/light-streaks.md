            ...
            <div class="col-lg-12 col-md-12 nopadding doc-page">
                <div class="col-lg-3 col-md-12 nopadding doc-nav">
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li class="active"><a href="#">Light Streaks <span class="badge">1.4</span></a></li>
                ...
                <div class="col-lg-9 col-md-12 doc-content">
                    ...
                    <p class="box-note">
                        This effect works best when HDR is enabled on your camera and your scene contains strong light sources or emissive materials. A luminous intensity of 1 corresponds to a full-white, nonemissive object.
                    </p>
                    <h2>Parameters</h2>
                    <h3>Strength <span class="badge">Float</span></h3>
                        How far the light streaks extend.
                    <h3>Luminance Threshold <span class="badge">Float</span></h3>
                        Any pixel below this luminance will not emit light streaks.
                    <h2>Known Issues</h2>
                </div>
            </div>
        </div>
