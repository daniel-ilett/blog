            ...
            <div class="col-lg-12 col-md-12 nopadding doc-page">
                <div class="col-lg-3 col-md-12 nopadding doc-nav">
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li class="active"><a href="#">Outline (Sobel) <span class="badge">1.0</span></a></li>
                ...
                <div class="col-lg-9 col-md-12 doc-content">
                    ...
                    <h3>Threshold <span class="badge">Float</span></h3>
                        How sensitive the edge-detection algorithm is.
                    <h3>Outline Color <span class="badge">Color</span></h3>
