            ...
            <div class="col-lg-12 col-md-12 nopadding doc-page">
                <div class="col-lg-3 col-md-12 nopadding doc-nav">
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li class="active"><a href="#">Vortex <span class="badge">1.5</span></a></li>
                ...
                <div class="col-lg-9 col-md-12 doc-content">
                    <h1>Vortex</h1>
                    <p>
                        The vortex effect warps the image around a centre point in a swirling pattern.
                    </p>
                    <h2>Parameters</h2>
                    <h3>Strength <span class="badge">Float</span></h3>
                        How strongly to warp the image around the center. Higher values mean more intense warping.
                    <h3>Center <span class="badge">Vector2</span></h3>
                        UV position to use as the centre of rotation. By default, this is at (0.5, 0.5).
                    <h3>Offset <span class="badge">Vector2</span></h3>
                        UV offset to apply to the image before the rotation takes place.
                    <h2>Known Issues</h2>
                </div>
            </div>
        </div>
