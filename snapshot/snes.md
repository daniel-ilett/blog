            ...
            <div class="col-lg-12 col-md-12 nopadding doc-page">
                <div class="col-lg-3 col-md-12 nopadding doc-nav">
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li class="active"><a href="#">SNES <span class="badge">1.0</span></a></li>
                ...
                <div class="col-lg-9 col-md-12 doc-content">
                    <h1>SNES</h1>
                    <p>
                        The SNES effect quantises each colour channel to a set number of levels. 6 levels gives the approximate colour palette of the SNES, and 4 gives the approximate colour palette of the NES.
                    </p>
                    <h2>Parameters</h2>
                    <h3>Enabled <span class="badge">Bool</span></h3>
                        Is the effect active?
                    <h3>Banding Levels <span class="badge">Int</span></h3>
                        The number of quantisation levels to use.
                    <h2>Known Issues</h2>
                </div>
            </div>
        </div>
